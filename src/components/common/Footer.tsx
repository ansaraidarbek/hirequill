...
const Footer = ({ className = '' }: FooterProps) => {
  ...
  return (
    <footer className={`w-full bg-surface-dark text-surface-dark-foreground ${className}`}>
      <div className="container mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            <Link href="/main-landing-page" className="flex items-center space-x-2 mb-4">
              <svg 
                width="40" 
                height="40" 
                viewBox="0 0 40 40" 
              ...
              <span className="text-xl font-bold font-headline">CoverCraft AI</span>
            </Link>
            <p className="text-sm text-gray-400 max-w-md font-body">
              Never write a cover letter again. Generate personalized, professional cover letters in 10 seconds with AI-powered automation.
            </p>
          </div>

          <div>
            <h3 className="text-sm font-semibold mb-4 font-headline">Product</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold mb-4 font-headline">Legal</h3>
            <ul className="space-y-2">
